...
-- 테이블 데이터 test.dept:~4 rows (대략적) 내보내기
...
-- 테이블 데이터 test.emp:~14 rows (대략적) 내보내기
...
CREATE TABLE IF NOT EXISTS `member` (
  ...
  `IRUM` varchar(20) CHARACTER SET utf8 NOT NULL,
  `SIDO` varchar(10) CHARACTER SET utf8 NOT NULL,
  `GUGUN` varchar(20) CHARACTER SET utf8 NOT NULL,
  `DONG` varchar(100) CHARACTER SET utf8 NOT NULL,
  `BUNJI` varchar(17) CHARACTER SET utf8 DEFAULT NULL,
  `ZIPCODE` char(7) CHARACTER SET utf8 NOT NULL,
  PRIMARY KEY (`PHONE`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- 테이블 데이터 test.member:~10 rows (대략적) 내보내기
/*!40000 ALTER TABLE `member` DISABLE KEYS */;
INSERT INTO `member` (`PHONE`, `IRUM`, `SIDO`, `GUGUN`, `DONG`, `BUNJI`, `ZIPCODE`) VALUES
	('02-111-1111', '공유', '서울', '구로구', '오류1동 동부골든아파트', '', '152-783'),
	('02-123-4567', '홍길동', '서울', '강남구', '개포1동 경남아파트', '', '135-806'),
	('02-203-4444', '박찬호', '서울', '동대문구', '휘경2동', '', '130-092'),
	('02-222-2222', '윤은혜', '서울', '광진구', '군자동', '345∼374', '143-840'),
	('02-244-2424', '한지민', '서울', '동작구', '노량진1동', '13∼112', '156-800'),
	('02-333-3333', '나훈아', '서울', '강동구', '천호3동', '', '134-023'),
	('02-345-7777', '조성모', '서울', '영등포구', '대림3동', '718∼774', '150-815'),
	('02-3482-6777', '이영애', '서울', '강남구', '개포1동 경남아파트', '', '135-806'),
	('02-888-5555', '선동열', '서울', '노원구', '중계1동 신안아파트', '', '139-922'),
	('02-974-4567', '이미자', '서울', '성동구', '옥수동', '', '133-100');
...
-- 테이블 world.infrun_member 구조 내보내기
CREATE TABLE IF NOT EXISTS `infrun_member` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `NAME` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8;

-- 테이블 데이터 world.infrun_member:~6 rows (대략적) 내보내기
/*!40000 ALTER TABLE `infrun_member` DISABLE KEYS */;
INSERT INTO `infrun_member` (`id`, `NAME`) VALUES
	(1, 'SPRING'),
	(2, 'SPRING2'),
	(3, '안병현'),
	(5, 'spring3'),
	...
	(9, '23'),
	(10, '55');
/*!40000 ALTER TABLE `infrun_member` ENABLE KEYS */;

-- 테이블 world.member 구조 내보내기
CREATE TABLE IF NOT EXISTS `member` (
...
-- 테이블 데이터 world.member:~2 rows (대략적) 내보내기
/*!40000 ALTER TABLE `member` DISABLE KEYS */;
INSERT INTO `member` (`username`, `gender`, `userage`, `hobby`, `city`) VALUES
	('sis923', '1', 0, '낚시', ''),
	('하a馬', '1', 1, '낚시', '서울'),
	('한지민', '1', 1, '낚시', '서울');
/*!40000 ALTER TABLE `member` ENABLE KEYS */;
